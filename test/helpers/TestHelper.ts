...
export const createHeidelpayInstance = () => new Unzer('s-priv-2a104MLt3Mm0ZVJAf0URjJphuPfYVUdF', 'en')
...
export const createPaymentTypeCard3ds = (unzer) => async (builder: boolean = false): Promise<Card> => {
  let card: Card = new Card()
    .setNumber('4711100000000000')
    .setCVC('123')
    .setExpiryDate('01/2022')
...
export const createBasket = () => {
  ...
  const basketItem: basketItemObject = {
    ...
    imageUrl: "https://www.heidelpay.com/typo3conf/ext/heidelpay_site/Resources/Public/Images/Unzer-Logo_weiss.svg",
